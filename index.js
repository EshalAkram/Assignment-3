...
let movie_name = "The Childe";
console.log(movie_name);
//Create a template string to introduce yourself, including your name and age.
let my_firstname = "Eshal";
let my_lastname = "Akram";
let my_age = 22;
let my_introduction = `Assalam-o-Alaikum:) i'm ${my_firstname}${my_lastname} i'm ${my_age} years old & I wanna become Developer`;
console.log(my_introduction);
//Initialize a constant with a type annotation for your current mood as a boolean.
const my_currentmood = true;
console.log(my_currentmood);
//Combine a user's first and last name using template literals and log the full name.
let user_firstname = my_firstname;
let user_lastname = my_lastname;
let user_fullname = `${user_firstname}${user_lastname}`;
...
let product_name = "Sunscreen";
let product_price = 2000;
...
let my_city = "Lahore";
let my_fulladdress = `${my_city} ${my_country}`;
console.log(my_fulladdress);
//Declare a variable for today's temperature with a number type annotation and assign a value to it.
let today_temperature = 18;
console.log(today_temperature);
